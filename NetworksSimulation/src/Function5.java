...
*/					
		...
		/*	System.out.println("Link 1 : "+opcount);
			...
			*/
			  ...
			  if(out1==1) 
			  { 
				  String file1= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink1.txt";
				  hextobinary(file1,1); 
			  }
			  if(out2==1) 
			  { 
				  String file2= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink2.txt";
				  hextobinary(file2,2); 
			  }
			  if(out3==1) 
			  { 
		  		  String file3= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink3.txt";
		  		  hextobinary(file3,3); 
			  }
...
public static void deletetable() {
	...
	File file1 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink1.txt");
	File file2 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink2.txt");
	File file3 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink3.txt");
	File file4 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\BinaryOutput1");
	File file5 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\BinaryOutput2");
	File file6 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\BinaryOutput3");
...
public static void opendialog() {
	...
	public StringBuilder convertToHex() throws IOException {
		int incount = 0;
		//String Link1 = "\\Users\\Pratik\\workspace\\NetworkSimulation\\src\\Links\\Ph2Link1_MD1";
		String Link2 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput2";
		String Link3 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary\\BinaryOutput3";
		...
		while ((value = is2.read()) != -1 || (value = is3.read()) != -1) {
			// convert to hex value with "X" formatter
			sbHex.append(String.format("%02X", value));
...
*/						bytesCounter = 0;
	...
	private String maskitems(String ipaddress) {
		...
		int longest;
		// String outputqueue = null;
		String Route = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\RoutingFinal5.txt";
...
*/	}
	...
	private void Sendermodule(String packet, String destination, String qno) throws IOException {
		...
		if (destination.equals(a)) {
			...
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink1.txt");
			try {
				if (log.exists() == false) {
			...
			File log2 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink2.txt");
			try {
				if (log2.exists() == false) {
			...
			File log3 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink3.txt");
			try {
			...
			)
	{
		...
		while(!Q21.isEmpty())
		{
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink2.txt");
			try {
				if (log.exists() == false) {
					// System.out.println("We had to make a new file 1.");
					log.createNewFile();
		...
		while(!Q31.isEmpty())
		{
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\Outputlink3.txt");
			try {
				if (log.exists() == false) {
					// System.out.println("We had to make a new file 1.");
					log.createNewFile();
	...
	public void hextobinary(String file, int a) throws IOException {
		...
		if (a == 1) {
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\Binary5Output1");
			src = br.readLine();
			while (src != null) {
			...
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\BinaryOutput2");
			src = br.readLine();
			while (src != null) {
				src = src.replace(" ", ""); // Trim out the spaces
				for (int i = 0; i < src.length(); i += 2) {
			...
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\BinaryOutput3");
			src = br.readLine();
			while (src != null) {
				src = src.replace(" ", ""); // Trim out the spaces
				for (int i = 0; i < src.length(); i += 2) {
