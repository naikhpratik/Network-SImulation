...
public class Function3 {
	...
	/*ArrayList<Long> pcketintime11 = new ArrayList<Long>();
	ArrayList<Long> pcketouttime11 = new ArrayList<Long>();
	ArrayList<Long> pcketintime12 = new ArrayList<Long>();
	ArrayList<Long> pcketouttime12 = new ArrayList<Long>();
	ArrayList<Long> totaltime11 = new ArrayList<Long>();
	ArrayList<Long> totaltime12 = new ArrayList<Long>();
	ArrayList<Long> packetqueueintime11 = new ArrayList<Long>();
	ArrayList<Long> packetqueueouttime11 = new ArrayList<Long>();
	ArrayList<Long> packetqueueintime12 = new ArrayList<Long>();
	ArrayList<Long> packetqueueouttime12 = new ArrayList<Long>();*/
	/************ End ************/	
	int Qpackets = 0;
	int Q2packets = 0;
	int out1 = 0;
	...
	int Qs32=0;
	int Qs33=0;
	int Queuein11;int Queuein21;int Queuein31;
	int Queuein12;int Queuein22;int Queuein32;
	int Queuein13;int Queuein23;int Queuein33;
	int Queueout11;int Queueout21;int Queueout31;
	int Queueout12;int Queueout22;int Queueout32;
	int Queueout13;int Queueout23;int Queueout33;
	int outcount11=0;
	int outcount12=0;
	int outcount13=0;
	int outcount21=0;
	...
	public void callfunctions() throws IOException {
		...
		try {
			...
			*/
			  ...
			  if(out1==1) 
			  { 
				  String file1= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink1.txt";
				  hextobinary(file1,1); 
			  }
			  if(out2==1) 
			  { 
				  String file2= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink2.txt";
				  hextobinary(file2,2); 
			  }
			  if(out3==1) 
			  { 
		  		  String file3= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink3.txt";
		  		  hextobinary(file3,3); 
			  }
		...
		/*System.out.println(Queuein11+" "+Queuein12);
		System.out.println(Queuein21+" "+Queuein22);
		System.out.println(Queuein31+" "+Queuein32);
		System.out.println(Queueout11+" "+Queueout12);
		System.out.println(Queueout21+" "+Queueout22);
		System.out.println(Queueout31+" "+Queueout32);*/
	}
public static void deletetable() {
	...
	File file4 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput1");
	File file5 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput2");
	File file6 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput3");
...
public static void opendialog() {
	...
	public StringBuilder convertToHex() throws IOException {
		int incount = 0;
		String Link1 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary\\BinaryOutput2";
		//String Link2 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\Ph2Link2_MD1";
		//String Link3 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\Ph2Link3_MD1";
		//InputStream is1 = new FileInputStream(Link1);
		InputStream is2 = new FileInputStream(Link1);
		...
		//is1.close();
		is2.close();
		System.out.println("Size of F3 list : "+list1.size());
		//is3.close();
		return sbHex;
	}
	...
	public void classifier(String packet, String ipaddress) throws IOException {
		...
		//System.out.println("Total No of items Aaya in F3: " + Entered);
	...
	private String maskitems(String ipaddress) {
		...
		int longest;
		// String outputqueue = null;
		String Route = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\RoutingFinal3.txt";
...
*/	}
	...
	private void Schnqueue(String packet, String destination, String qno) throws IOException {
		...
		// System.out.println("Destination : "+Destination);
			...
			while (!queue2.isEmpty() && packetentered==1539) {
	...
	private void Sendermodule(String packet, String destination, String qno) throws IOException {
		...
		// System.out.println("In sender module"+destination+" : "+qno);
		String a = "01";
		String b = "02";
		String c = "03";
		if (destination.equals(a)) {
			...
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink1.txt");
			try {
				if (log.exists() == false) {
			...
			File log2 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink2.txt");
			try {
				if (log2.exists() == false) {
			...
			File log3 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink3.txt");
			try {
	...
	while(queue2.isEmpty() && packetentered2==1539 &&
			...
			)
	{
		...
		while(!Q21.isEmpty())
		{
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink2.txt");
			try {
				if (log.exists() == false) {
					// System.out.println("We had to make a new file 1.");
					log.createNewFile();
		...
		while(!Q31.isEmpty())
		{
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\Outputlink3.txt");
			try {
				if (log.exists() == false) {
					// System.out.println("We had to make a new file 1.");
					log.createNewFile();
	...
	public void hextobinary(String file, int a) throws IOException {
		...
		if (a == 1) {
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput1");
			src = br.readLine();
			while (src != null) {
			...
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput2");
			src = br.readLine();
			while (src != null) {
				src = src.replace(" ", ""); // Trim out the spaces
				for (int i = 0; i < src.length(); i += 2) {
			...
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\BinaryOutput3");
			src = br.readLine();
			while (src != null) {
				src = src.replace(" ", ""); // Trim out the spaces
				for (int i = 0; i < src.length(); i += 2) {
