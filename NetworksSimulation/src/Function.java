...
public class Function {
	...
	int Qs32=0;
	int Qs33=0;
	static int Queuein11;static int Queuein21;static int Queuein31;
	static int Queuein12;static int Queuein22;static int Queuein32;
	static int Queuein13;static int Queuein23;static int Queuein33;
	static int Queueout11;static int Queueout21;static int Queueout31;
	static int Queueout12;static int Queueout22;static int Queueout32;
	static int Queueout13;static int Queueout23;static int Queueout33;
	int outcount11=0;
	int outcount12=0;
	int outcount13=0;
	int outcount21=0;
	...
	public void callfunctions() throws IOException {
		...
		try {
			...
			*/
			  ...
			  if(out1==1) 
			  { 
				  String file1= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink1.txt";
				  hextobinary(file1,1); 
			  }
			  if(out2==1) 
			  { 
				  String file2= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink2.txt";
				  hextobinary(file2,2); 
			  }
			  if(out3==1) 
			  { 
		  		  String file3= "C:\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink3.txt";
		  		  hextobinary(file3,3); 
			  }
...
public static void deletetable() {
	...
	String file1 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\";
	String file2 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks2\\";
	String file3 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks3\\";
	String file4 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary\\";
	String file5 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary2\\";
	String file6 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary3\\";
	String file7 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary4\\";
	String file8 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary5\\";
	String file9 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary6\\";
	String file10 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks4\\";
	String file11 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks5\\";
	String file12 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks6\\";
	String file13 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary7\\";
	String file14 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks7\\";
	
	File file31 = new File(file1);
    File[] files31 = file31.listFiles(); 
    for (File f:files31) 
    {
    ...
    File file32 = new File(file4);
    File[] files32 = file32.listFiles(); 
    for (File f:files32) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file34 = new File(file6);
    File[] files34 = file34.listFiles(); 
    for (File f:files34) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file35 = new File(file2);
    File[] files35 = file35.listFiles(); 
    for (File f:files35) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file36 = new File(file5);
    File[] files36 = file36.listFiles(); 
    for (File f:files36) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file37 = new File(file7);
    File[] files37 = file37.listFiles(); 
    for (File f:files37) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file38 = new File(file10);
    File[] files38 = file38.listFiles(); 
    for (File f:files38) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file39 = new File(file12);
    File[] files39 = file39.listFiles(); 
    for (File f:files39) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file40 = new File(file9);
    File[] files40 = file40.listFiles(); 
    for (File f:files40) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file41 = new File(file13);
    File[] files41 = file41.listFiles(); 
    for (File f:files41) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file42 = new File(file14);
    File[] files42 = file42.listFiles(); 
    for (File f:files42) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file43 = new File(file8);
    File[] files43 = file43.listFiles(); 
    for (File f:files42) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
    ...
    File file44 = new File(file11);
    File[] files44 = file44.listFiles(); 
    for (File f:files44) 
    {
    	if (f.isFile() && f.exists()) 
        { f.delete();
...
static String ftable;
	...
	private void Convertroutingtable() throws IOException {
		...
		String router = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\Ph4ForwardingTable";
		System.out.println(ftable);
		InputStream is = new FileInputStream(router);
		...
		File log10 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\RoutingFinal.txt");
...
public static void opendialog() {
	...
	public StringBuilder convertToHex() throws IOException {
		int incount = 0;
		String Link1 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\Ph4_Link1_MD1";
		String Link2 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\Ph4_Link2_MD1";
		String Link3 = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\Ph4_Link3_MD1";
	...
	private String maskitems(String ipaddress) {
		...
		int longest;
		// String outputqueue = null;
		String Route = "\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Links\\RoutingFinal.txt";
...
*/	}
	...
	private void Schnqueue(String packet, String destination, String qno) throws IOException {
		...
		// System.out.println("Destination : "+Destination);
			...
			while (!queue2.isEmpty() && packetentered==4500) {
	...
	private void Sendermodule(String packet, String destination, String qno) throws IOException {
		...
		if (destination.equals(a)) {
			...
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink1.txt");
			try {
				if (log.exists() == false) {
				...
				while(over)
				{
					if(qno.equals("01") && Qs11<Queuein11)
					{
						Q11.add(packet);
						Qincount11++;
				...
				//		System.out.println("Q11: "+Q11.size());
					...
					if(qno.equals("02") && Qs12<Queuein12)
					{	
						Q12.add(packet);
					...
					if(qno.equals("03") && Qs13<Queuein13)
					{
						Q13.add(packet);
						Qincount13++;
			...
			File log3 = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink3.txt");
			try {
				...
				while(over)
				{
					if(qno.equals("01") && Qs31<Queuein31)
					{	
						Q31.add(packet);
					...
					if(qno.equals("02") && Qs32 < Queuein32)
					{	
						Q32.add(packet);
					...
					if(qno.equals("03") && Qs33<Queuein33)
					{	
						Q33.add(packet);
	...
	while(queue2.isEmpty() && packetentered2==4500 &&
			...
			)
	{
		...
		while(!Q21.isEmpty())
		{
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink2.txt");
			try {
				if (log.exists() == false) {
					// System.out.println("We had to make a new file 1.");
					log.createNewFile();
		...
		while(!Q31.isEmpty())
		{
			File log = new File("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\OutputLinks\\Outputlink3.txt");
			try {
				if (log.exists() == false) {
					// System.out.println("We had to make a new file 1.");
					log.createNewFile();
	...
	public void hextobinary(String file, int a) throws IOException {
		...
		if (a == 1) {
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary\\BinaryOutput1");
			src = br.readLine();
			while (src != null) {
			...
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary\\BinaryOutput2");
			src = br.readLine();
			while (src != null) {
				src = src.replace(" ", ""); // Trim out the spaces
				for (int i = 0; i < src.length(); i += 2) {
			...
			PrintWriter writer = new PrintWriter("\\Users\\Pratik\\workspace\\NetworksSimulation\\src\\Binary\\BinaryOutput3");
			src = br.readLine();
			while (src != null) {
				src = src.replace(" ", ""); // Trim out the spaces
				for (int i = 0; i < src.length(); i += 2) {
